...
(function () {
		...
		return {
			define: function (b, d) {
				...
				if (0 > e.getListenerIndex(d)) {
					...
					p.fn = d;
					p.priority = h;
					for (var v = e.length - 1; 0 <= v; v--) if (e[v].priority <= h) return e.splice(v + 1, 0, p), {removeListener: q};
					e.unshift(p)
				}
			...
			once: function () {
				...
				return function (h, p, q) {
					...
					if (e) {
						var v = e.listeners;
						if (v.length) for (var v = v.slice(0), x, F = 0; F < v.length; F++) {
							if (e.errorProof) try {
								x =
									v[F].call(this, q, p, b, k)
							} catch (u) {
							} else x = v[F].call(this, q, p, b, k);
			...
			is: function () {
				...
				if (document.documentElement.getBoundingClientRect && (CKEDITOR.env.ie ?
					...
					var f = this.$.getBoundingClientRect(), g = e.$.documentElement,
						u = g.clientTop || d.$.clientTop || 0, m = g.clientLeft || d.$.clientLeft || 0, k = !0;
				...
				v = a.getWindow();
				d = u(this, v);
				var w = u(a, v), H = this.$.offsetHeight;
				e = this.$.offsetWidth;
	...
	(function () {
		function a(a, b) {
			...
			e = c.endContainer;
			var f = c.startOffset, y = c.endOffset, g, n = this.guard, r = this.type,
	...
	(function () {
		...
		function d(a, b, c, d, f) {
			...
			var r = a.startContainer, C = a.endContainer,
				L = a.startOffset, E = a.endOffset, N, t, D, z, I, P;
			if (n && C.type == CKEDITOR.NODE_TEXT && (r.equals(C) || r.type === CKEDITOR.NODE_ELEMENT && r.getFirst().equals(C))) c.append(a.document.createText(C.substring(L, E))); else {
			...
			trim: function (a, b) {
				...
				switch (a) {
					...
					case CKEDITOR.ENLARGE_ELEMENT:
						...
						var m = this.getCommonAncestor(), h = this.root, k, q, n, r, C, L = !1, E, N;
						...
						for (n = c(n); n || r;) {
							...
							for (; r;) if (E = !1, r.type == CKEDITOR.NODE_COMMENT) r = r.getPrevious(); else {
								if (r.type == CKEDITOR.NODE_TEXT) N = r.getText(), d.test(N) && (r = null), E = /[\s\ufeff]$/.test(N); else if ((r.$.offsetWidth > (CKEDITOR.env.webkit ? 1 : 0) || b && r.is("br")) && !r.data("cke-bookmark")) if (L && CKEDITOR.dtd.$removeEmpty[r.getName()]) {
									N =
										r.getText();
									if (d.test(N)) r = null; else for (var t = r.$.getElementsByTagName("*"), D = 0, z; z = t[D++];) if (!CKEDITOR.dtd.$removeEmpty[z.nodeName.toLowerCase()]) {
										r = null;
										break
									}
									r && (E = !!N.length)
						...
						for (; n || r;) {
							...
							for (; r;) {
								E = !1;
								if (r.type == CKEDITOR.NODE_TEXT) N = r.getText(), g(r, 0) || (r = null), E = /^[\s\ufeff]/.test(N); else if (r.type == CKEDITOR.NODE_ELEMENT) {
									if ((0 < r.$.offsetWidth || b && r.is("br")) && !r.data("cke-bookmark")) if (L && CKEDITOR.dtd.$removeEmpty[r.getName()]) {
										N =
											r.getText();
										if (d.test(N)) r = null; else for (t = r.$.getElementsByTagName("*"), D = 0; z = t[D++];) if (!CKEDITOR.dtd.$removeEmpty[z.nodeName.toLowerCase()]) {
											r = null;
											break
										}
										r && (E = !!N.length)
		...
		a.prototype = {
			getNextParagraph: function (a) {
				...
				if (!this._.started) {
					...
					k = u.startPath();
					var m = u.endPath(), M = !u.collapsed && c(u, k.block), w = !u.collapsed && c(u, m.block, 1);
				...
				for (this._.nextNode = null; m;) {
					var M = 0, w = m.hasAscendant("pre"), H = m.type != CKEDITOR.NODE_ELEMENT, n = 0;
					if (H) m.type == CKEDITOR.NODE_TEXT && f.test(m.getText()) && (H = 0); else {
						...
						if (CKEDITOR.dtd.$block[r] && "false" == m.getAttribute("contenteditable")) {
							...
							b(this, a, d);
							break
						} else if (m.isBlockBoundary(this.forceBrBreak && !w && {br: 1})) {
					...
					v = (!M || H) && m.equals(u);
					if (k && !M) for (; !m.getNext(h) && !v;) {
						r = m.getParent();
						if (r.isBlockBoundary(this.forceBrBreak && !w && {br: 1})) {
							M = 1;
							H = 0;
							v || r.equals(u);
	...
	(function () {
		function a(a, b, c, d, e) {
			...
			for (f in b) {
				...
				for (g in P) {
					l[g] = k(l[g], m) || null;
					var r = l, t = O[g], z = k(l[O[g]], m), B = l[g], h = [], A = !0, C = void 0;
					z ? A = !1 : z = {};
		...
		function x(a, b, e, f) {
			...
			if (f.doCallbacks && a.elementCallbacks) {
				a:{
					...
					for (var g = 0, t = n.length, D; g < t; ++g) if (D = n[g](b)) {
						n = D;
						break a
					}
					n = void 0
			...
			if (f.doFilter) {
				a:{
					...
					if (a || n) {
						v(b);
						if (g) for (k = 0, C = g.length; k < C; ++k) if (!1 === c(g[k], b, z)) {
							a = null;
							break a
						}
						if (t) for (k = 0, C = t.length; k < C; ++k) c(t[k], b, z);
						if (a) for (k = 0, C = a.length; k < C; ++k) d(a[k], b, z, D);
						if (n) for (k = 0, C = n.length; k < C; ++k) d(n[k], b, z, D);
						a = z
					} else a = null
				}
				...
				D = b.classBackup;
				var L = b.styleBackup, K, E, O = [], z = [], J = /^data-cke-/;
				k = !1;
				delete g.style;
				delete g["class"];
				delete b.classBackup;
				delete b.styleBackup;
				if (!a.allAttributes) for (K in g) C[K] || (J.test(K) ? K == (E = K.replace(/^data-cke-saved-/, "")) || C[E] || (delete g[K], k = !0) : (delete g[K], k = !0));
		...
		function n(a, b, c) {
			...
			if (t.$empty[d] || !a.children.length) "hr" == d && "br" == b ? a.replaceWith(w()) : (a.parent && c.push({
				check: "it",
				el: a.parent
			}), a.remove()); else if (t.$block[d] || "tr" == d) if ("br" == b) a.previous && !H(a.previous) && (b = w(), b.insertBefore(a)), a.next && !H(a.next) && (b = w(), b.insertAfter(a)), a.replaceWithChildren(); else {
				var d = a.children, e;
				b:{
					e = t[b];
		...
		var t = CKEDITOR.dtd, D = CKEDITOR.tools.copy, z = CKEDITOR.tools.trim, I = ["", "p", "br", "div"];
		...
		CKEDITOR.filter.prototype = {
			allow: function (b, c, d) {
				...
				var e = this, f = [], l = this.editor && this.editor.config.protectedSource, g, r = !1,
					D = {doFilter: !c, doTransform: !0, doCallbacks: !0, toHtml: b};
				a.forEach(function (a) {
					if (a.type == CKEDITOR.NODE_ELEMENT) {
						if ("off" == a.attributes["data-cke-filter"]) return !1;
						if (!b || "span" != a.name || !~CKEDITOR.tools.objectKeys(a.attributes).join("|").indexOf("data-cke-")) if (g = x(e, a, f, D), g & 1) r = !0; else if (g & 2) return !1
						...
						a:{
							...
							1 == d.children.length && (n = d.children[0]).type == CKEDITOR.NODE_ELEMENT && x(e, n, c, D);
							c = !c.length
						}
						c || f.push(a)
					}
				...
				for (; z = a.pop();) if (c = z.el, c.parent) switch (k = t[c.parent.name] || t.span, z.check) {
					case "it":
			...
			addContentForms: function (a) {
				...
				x(this, l, g, {doFilter: !0, doTransform: !1 !== b, skipRequired: !c, skipFinalValidation: !c});
		...
		return function (b, c, f) {
			var g = {}, k = function (b) {
				a.call(this, b, function (a) {
					...
					var b = [], e;
					for (e in a) {
						var h = a[e], v = h && h.requires;
						if (!d[e]) {
							if (h.icons) for (var x = h.icons.split(","), F = x.length; F--;) CKEDITOR.skin.addIcon(x[F], h.path + "icons/" + (CKEDITOR.env.hidpi && h.hidpi ? "hidpi/" : "") + x[F] + ".png");
							d[e] = 1
						}
						if (v) for (v.split && (v = v.split(",")), h = 0; h < v.length; h++) g[v[h]] || b.push(v[h])
					}
	...
	(function () {
		...
		CKEDITOR.tools.extend(CKEDITOR.editor.prototype, {
			plugins: {
				...
				if (c) {
					var e =
						CKEDITOR.tools.object.findKey(this.commands, c), f = this.keystrokeHandler.keystrokes;
			...
			function (g, k, h) {
				function p(a) {
					...
					if (0 < m.length) for (var c = 0; c < m.length; c++) {
						var d = m[c], e = d.name, f = CKEDITOR.dtd[e], n = w.name && CKEDITOR.dtd[w.name];
				...
				var F = new CKEDITOR.htmlParser,
					...
					m = [], M = [], w = u, H = "textarea" == u.name, n = "pre" == u.name;
					...
					if (a(f)) m.push(f); else {
						...
						if ("br" == e) M.push(f); else {
							for (; !(k = (g = w.name) ? CKEDITOR.dtd[g] || (w._.isBlockLike ? CKEDITOR.dtd.div : CKEDITOR.dtd.span) : c, f.isUnknown || w.isUnknown || k[e]);) if (w.isOptionalClose) F.onTagClose(g); else if (e in b && g in b) g = w.children, (g = g[g.length - 1]) && "li" == g.name || y(g = new CKEDITOR.htmlParser.element("li"), w), !f.returnPoint && (f.returnPoint = w), w = g; else if (e in CKEDITOR.dtd.$listItem &&
								!x(e, g)) F.onTagOpen("li" == e ? "ul" : "dl", {}, 0, 1); else if (g in d && !x(e, g)) !f.returnPoint && (f.returnPoint = w), w = w.parent; else if (g in CKEDITOR.dtd.$inline && m.unshift(w), w.parent) y(w, w.parent, 1); else {
								f.isOrphan = 1;
								break
							}
							p(e);
		...
		a.prototype = {
			add: function (a, c, d) {
				...
				var d = c instanceof CKEDITOR.htmlParser.node || c instanceof CKEDITOR.htmlParser.fragment,
					g = Array.prototype.slice.call(arguments, 1), k = this.rules, h = k.length, p, q, e, y;
				for (y = 0; y < h; y++) if (d && (p = c.type, q = c.name), e = k[y], !(a.nonEditable && !e.options.applyToAll ||
	...
	(function () {
		function a(a, d) {
			...
			function l(a, d) {
				return function (f) {
					if (f.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT) {
						var l = [], n = b(f), D, G;
						if (n) for (t(n, 1) && l.push(n); n;) g(n) && (D = c(n)) && t(D) && ((G = c(D)) && !g(G) ? l.push(D) : (e(z).insertAfter(D), D.remove())), n = n.previous;
			...
			var D = {elements: {}}, z = "html" == d, B = CKEDITOR.tools.extend({}, C), h;
		...
		var w = /(?:&nbsp;|\xa0)$/, H = "{cke_protected}", n = CKEDITOR.dtd,
			r = "caption colgroup col thead tfoot tbody".split(" "),
			C = CKEDITOR.tools.extend({}, n.$blockLimit, n.$block), L = {elements: {input: h, textarea: h}}, E = {
	...
	(function () {
		...
		u = function () {
			...
			function b(c, d) {
				var e, f, g, t, k = [], z = d.range.startContainer;
				e = d.range.startPath();
			...
			function d(b, c) {
				var e = [], f = b.getChildren(), g = f.count(),
					t, k = 0, h = D[c], z = !b.is(D.$inline) || b.is("br");
			...
			return function (z, l, K, B) {
				...
				if (!B.checkReadOnly()) {
					...
					if (!l.collapsed) {
						var A = G.block || G.blockLimit, v = l.getCommonAncestor();
					...
					if (q = K) {
						...
						if ((u = q.startPath().block) && (1 !=
							...
							if (1 == p.getChildCount() && a(y = p.getFirst()) && y.is(I) && !y.hasAttribute("contenteditable")) {
								...
								q = 0;
								for (B = u.count(); q < B; q++) if (l = u.getItem(q), !l.is(m)) break a;
					...
					if (q) {
						...
						var H, M;
						l = y.startContainer;
						var J = z.endPath.elements[0], W, G = J.getPosition(l),
						...
						for (t(l, y); B < l.length; B++) {
							...
							if (x) K = 0 < B; else {
								...
								if (A && G.isElement) {
									...
									if (x) H && (M = y.splitElement(H), z.zombies.push(M), z.zombies.push(H)); else {
										H = p.getName();
										W = !B;
										x = B == l.length - 1;
										H = d(G.node, H);
					...
					if (M) for (; F = M.pop();) CKEDITOR.env.needsBrFiller ? F.appendBogus() : F.append(w.document.createText(" "));
	...
	(function () {
		...
		var m = "function" != typeof window.getSelection, M = 1, w = CKEDITOR.tools.repeat("​", 7),
			H = new RegExp(w + "( )?", "g"), n, r, C, L = CKEDITOR.dom.walker.invisible(1), E = function () {
				function a(b) {
					return function (a) {
						var c =
		...
		CKEDITOR.on("instanceCreated", function (a) {
			...
			c.on("contentDom", function () {
				...
				var e = c.document, f = CKEDITOR.document, h = c.editable(), t = e.getBody(),
					n = e.getDocumentElement(), D = h.isInline(), q, p;
	...
	(function () {
		...
		function b(c) {
			...
			if (c.collapsed) e = M(this, e), c.insertNode(e), c.moveToPosition(e, CKEDITOR.POSITION_BEFORE_END); else {
				...
				c.trim();
				var p = c.createBookmark(), t = p.startNode, v = p.endNode, r = t, y;
				if (!m) {
					var x = c.getCommonAncestor(), m = a(t, x), x = a(v, x);
					m && (r = m.getNextSourceNode(!0));
					x && (v = x)
				}
				for (r.getPosition(v) == CKEDITOR.POSITION_FOLLOWING && (r = 0); r;) {
					m = !1;
					if (r.equals(v)) r = null, m = !0; else {
						...
						if (x && n && CKEDITOR.dtd.$block[u]) for (var C = r, D = f(C), E = void 0, H = D.length, I = 0, C = H && new CKEDITOR.dom.range(C.getDocument()); I < H; ++I) {
						...
						!D.parentRule(E)) m = !0; else {
							if (y || u && CKEDITOR.dtd.$removeEmpty[u] && (r.getPosition(v) | P) != P || (y = c.clone(), y.setStartBefore(r)), u = r.type, u == CKEDITOR.NODE_TEXT || x || u == CKEDITOR.NODE_ELEMENT && !r.getChildCount()) {
								for (var u = r, N; (m = !u.getNext(z)) && (N = u.getParent(), q[N.getName()]) && d(N, t, h, O);) u = N;
								y.setEndAfter(u)
							}
						} else m = !0;
		...
		var E = {
				...
				audio: 1,
				video: 1
			}, t = /\s*(?:;\s*|$)/, D = /#\((.+?)\)/g, z = CKEDITOR.dom.walker.bookmark(0, 1),
...
*/
	...
	(function () {
		...
		function Y(a) {
			function b(b) {
				var c = "rtl" == f.lang.dir, n = k.width, q = k.height,
					...
					G = q + (b.data.$.screenY - m.y) * (a._.moved ? 1 : 2), A = a._.element.getFirst(),
					A = c && A.getComputedStyle("right"), B = a.getPosition();
		...
		function M(a) {
			var b = CKEDITOR.document.getWindow(), c = a.config, e = CKEDITOR.skinName || a.config.skin,
				...
				f = c.baseFloatZIndex, c = CKEDITOR.tools.genKey(d, e, f), g = y[c];
		...
		CKEDITOR.dialog = function (a, b) {
			...
			var g = CKEDITOR.dialog._.dialogDefinitions[b], h = CKEDITOR.tools.clone(Z),
		...
		var Z = {
			...
			for (var e = 0, d; d = a[e]; e++) if (d.id == b || c && d[c] && (d = C(d[c], b, c))) return d;
			return null
	...
	CKEDITOR.plugins.add("dialog", {
		requires: "dialogui", init: function (w) {
	...
	(function () {
		...
		function w(a) {
			...
			var p = CKEDITOR.plugins.clipboard, m = 0, u = 0;
			(function () {
				a.on("key", n);
				a.on("contentDom", b);
		...
		CKEDITOR.plugins.add("clipboard", {
			requires: "dialog,notification,toolbar", init: function (a) {
				...
				a.on("paste", function (b) {
					...
					if ("text" == d && "html" == g) f =
						v(a, f, c.get("plain-text")); else if (n && a.pasteFilter && !b.dontFilter || k) f = v(a, f, a.pasteFilter);
	...
	CKEDITOR.plugins.add("scayt", {
		...
		parseConfig: function (a) {
			...
			h && -1 == CKEDITOR.tools.indexOf(f, h.replace("grayt_", "")) && "all" != a.config.scayt_contextCommands || (e[h] = "undefined" != typeof b[h].state ? b[h].state : CKEDITOR.TRISTATE_OFF, "function" !== typeof b[h].verification || b[h].verification(a) || delete e[h], a.addCommand(h, {exec: b[h].exec}), a.addMenuItem(h, {
			...
			return {
				exec: function (b) {
					...
					"startGrammarCheck" ===
					d && b.removeMarkupInSelectionNode({grammarOnly: !0});
					b.fire(d)
				}
			}
		}
	...
	(function () {
		...
		function W(a, b) {
			function c(a, c) {
				var e = b.upcast.split(","), d, f;
				for (f = 0; f < e.length; f++) if (d =
		...
		function E(a, b) {
			...
			if (!d.getById("cke_copybin")) {
				...
				if (f) var n = d.getDocumentElement().$, r = n.scrollTop;
				l = c.createRange();
		...
		function fa(a) {
			...
			if (CKEDITOR.tools.getMouseButton(a) === CKEDITOR.MOUSE_BUTTON_LEFT) {
				...
				var r = c.greedySearch(), v = CKEDITOR.tools.eventsBuffer(50, function () {
					m = d.locate(r);
					k = d.sort(n, 1);
		...
		function ka() {
			...
			function c(a) {
				...
				function c(a) {
					function b(a, c) {
						var d = CKEDITOR.tools.objectKeys(a), e = CKEDITOR.tools.objectKeys(c);
			...
			CKEDITOR.style.addCustomHandler({
				type: "widget", setup: function (a) {
					...
					c = a.elementPath();
					if (this.checkApplicable(c, a)) for (var k = 0, m = this.group.length; k < m; k++) {
				...
				}, checkElementMatch: b, checkElementRemovable: b,
		...
		q.prototype = {
			MIN_SELECTION_CHECK_INTERVAL: 500, add: function (a, b) {
				...
				var a = this.editor.getSelection(), b = a.getSelectedElement(), c = F(this), d;
		...
		g.prototype = {
			...
			initEditable: function (a, b) {
				...
				return c && c.is(CKEDITOR.dtd.$editable) ? (c = new t(this.editor, c, {filter: A.call(this.repository, this.name, a, b)}), this.editables[a] = c, c.setAttributes({
		...
		var ba = /^(?:<(?:div|span)(?: data-cke-temp="1")?(?: id="cke_copybin")?(?: data-cke-temp="1")?>)?(?:<(?:div|span)(?: style="[^"]+")?>)?<span [^>]*data-cke-copybin-start="1"[^>]*>.?<\/span>([\s\S]+)<span [^>]*data-cke-copybin-end="1"[^>]*>.?<\/span>(?:<\/(?:div|span)>)?(?:<\/(?:div|span)>)?$/i,
			L = {37: 1, 38: 1, 39: 1, 40: 1, 8: 1, 46: 1};
